    ...
    return (
        <section className='abt-sec'>
            <div className="container about-container">
                 <h3 className='text-center'> <span><img src="/src/assets/img/lineicon-left.svg" alt="" /></span> আমাদের সম্পর্কে জানুন  <span><img src="/src/assets/img/line-icon.svg" alt="" /></span></h3>
                                ...
                                <div className="col-sm-12 col-md-12 col-lg-6 ">
                                    <div className="card border-0" key={i}>
                                        <div className="card-body pos-two">
                                            <p className='m-0 about-description'>{item['description']}</p>
